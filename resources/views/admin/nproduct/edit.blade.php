...
<div class="block">
        ...
        <form action="{{ route('nproduct.update',['id' => $nproduct->id ]) }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }} 
                ...
                <div class=" col-xl-12">
                     @include('admin.includes.errors')
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ $nproduct->title }}" class="form-control" >
                         </div>
