...
<div class="block">
        ...
        <form action="{{ route('features.update',['id' => $featured->id ]) }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }} 
                ...
                <div class=" col-xl-12">
                     @include('admin.includes.errors')
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ $featured->title }}" class="form-control" >
                         </div>
